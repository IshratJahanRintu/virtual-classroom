                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#editStudentModal"
                                   class="edit"
                                   data-toggle="modal"
                                   data-userid="<?php echo $student['user_id'] ?>"
                                   data-name="<?php echo $student['name'] ?>"
                                   data-phone="<?php echo $student['contact_no'] ?>"
                                   data-semester="<?php echo $student['semester'] ?>"><i class="material-icons"
                                       data-toggle="tooltip"
                                       title="Edit">&#xE254;</i></a>
                                <a href="#deleteStudentModal"
                                   class="delete"
                                   data-toggle="modal"
                                   data-userid="<?php echo $student['user_id'] ?>"><i class="material-icons"
                                       data-toggle="tooltip"
                                       title="Delete">&#xE872;</i></a>
                            </td>
                        </tr>
    ...
    <div id="addStudentModal"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="access-form"
                      action="handlers/addStudentHandler.php"
                      method="post"

                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#editTeacherModal"
                                   class="edit"
                                   data-toggle="modal"
                                   data-userid="<?php echo $teacher['user_id'] ?>"
                                   data-name="<?php echo $teacher['name'] ?>"
                                   data-phone="<?php echo $teacher['contact_no'] ?>"
                                   data-designation="<?php echo $teacher['designation'] ?>"><i class="material-icons"
                                       data-toggle="tooltip"
                                       title="Edit">&#xE254;</i></a>
                                <a href="#deleteTeacherModal"
                                   class="delete"
                                   data-toggle="modal"
                                   data-userid="<?php echo $teacher['user_id'] ?>"><i class="material-icons"
                                       data-toggle="tooltip"
                                       title="Delete">&#xE872;</i></a>
                            </td>
                        </tr>
    ...
    <div id="addTeacherModal"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="access-form"
                      action="handlers/addTeacherHandler.php"
                      method="post"

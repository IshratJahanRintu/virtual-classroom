...
<div class="course-whole-container">
    ...
    <div class="course-main-content">
        <div class=" notice-header">Announcement
            <div class="notice-btn-container">
                <button class="notice-btn"
                        data-toggle="modal"
                        data-target="#addNoticeModal">Add Announcement</button>
            </div>
        </div>
        ...
        <div class="notice-card">
            ...
            <div class="notice-card-right">
                ...
                <a href="#editNoticeModal"
                   ...
                   data-noticeid="<?php echo $n['notice_id'] ?>"><i class="zmdi zmdi-edit"></i></a>
            ...
            <div class="modal-dialog"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body mx-3">
                        ...
                        <div class="md-form">
                            <form action="handlers/editAnnouncementHandler.php"
                                  method="post">
                                <i class="fas fa-pencil prefix grey-text"></i>
                                ...
                                <label data-error="wrong"
                                       data-success="right"
                                       for="form8">Edit announcement</label>
        ...
        <div id="deleteNoticeModal"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="handlers/deleteNoticeHandler.php"
                          method="get">
